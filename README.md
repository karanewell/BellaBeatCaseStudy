...
The data comes from ![FitBit Fitness Tracker Data](https://www.kaggle.com/datasets/arashnic/fitbit) (CC0: Public Domain license), stored on Kaggle and made available by ![Mobius](https://www.kaggle.com/arashnic).
