...
In order to assure accuracy in the datasets I will initiate the command to find the different types (character, integer, numeric) of each column contained within the data using STR command.
